<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditEmployee.aspx.cs" Inherits="SZRBD.Kadry.HR.EditEmployee" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">


    
     <div>
            <h3 class="about-header">Edytuj pracownika</h3>
         <br />
    </div>
     <div class="row">
            <section id="advertForm">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="PESEL" CssClass="form-control" TextMode="SingleLine" />
