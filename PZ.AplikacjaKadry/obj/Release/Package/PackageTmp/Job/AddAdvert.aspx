<%@ Page Title="Dodaj ogłoszenie" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddAdvert.aspx.cs" Inherits="SZRBD.Kadry.Job.AddAdvert" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div>
            <h3 class="about-header">Dodaj ogłoszenie</h3>
         <br />
    </div>
     <div class="row">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            <asp:Button runat="server" ID="Add" OnClick="Add_Click" Text="Zatwierdź" CssClass="btn btn-info" />
