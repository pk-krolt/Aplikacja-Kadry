<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddPosition.aspx.cs" Inherits="SZRBD.Kadry.HR.AddPosition" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

     <div>
            <h3 class="about-header">Dodaj stanowisko</h3>
         <br />
    </div>
     <div class="row">
